...
{
    public class RecotacaoFreteItem : EntityBase
    {
        #region "Construtores"
        public RecotacaoFreteItem(int Id, int idTabela, EnumTabelaArquivoStatus idTabelaArquivoStatus, string dsNomeArquivo, string dsUrl, string dsModelo, string dsUrlResultado,
