...
{
    class OcorrenciaTipoMap : IEntityTypeConfiguration<OcorrenciaTipo>
    {
        public void Configure(EntityTypeBuilder<OcorrenciaTipo> builder)
        {
            builder.ToTable("Tb_Edi_OcorrenciaTipo", "dbo");
