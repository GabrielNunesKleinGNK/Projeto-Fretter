...
{
    class EntregaStageDestinatarioMap : IEntityTypeConfiguration<EntregaStageDestinatario>
    {
        public void Configure(EntityTypeBuilder<EntregaStageDestinatario> builder)
        {
            builder.ToTable("Tb_Edi_EntregaStageDestinatario", "dbo");
			...
			builder.Property(e => e.InscricaoEstadual).HasColumnName("Cd_InscricaoEstadual").HasColumnType("varchar").HasMaxLength(128);
			...
			builder.Property(e => e.Complemento).HasColumnName("Ds_Complemento").HasColumnType("varchar").HasMaxLength(256);
