...
{
    public class RegraTipoOperadorMap : IEntityTypeConfiguration<RegraTipoOperador>
    {
        public void Configure(EntityTypeBuilder<RegraTipoOperador> builder)
        {
            builder.ToTable("Tb_Age_RegraTipoOperador", "dbo");
