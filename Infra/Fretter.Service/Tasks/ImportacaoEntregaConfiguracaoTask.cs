...
namespace Fretter.Service.Tasks
{
    ...
    class ImportacaoEntregaConfiguracaoTask : IJob, IJobTask
    {
        private readonly ILogHelper _logHelper;
        private readonly IEntregaConfiguracaoApplication<FretterContext> _application;

        public ImportacaoEntregaConfiguracaoTask(ILogHelper logHelper, IEntregaConfiguracaoApplication<FretterContext> application)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                await _application.ProcessaEntregaConfiguracaoAtivo();
