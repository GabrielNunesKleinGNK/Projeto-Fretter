...
namespace Fretter.Service.Tasks.Conciliacao
{
    ...
    class ProcessaConciliacaoControleTask : IJob, IJobTask
    {
        private readonly ILogHelper _logHelper;
        private readonly IConciliacaoApplication<FretterContext> _application;

        public ProcessaConciliacaoControleTask(ILogHelper logHelper, IConciliacaoApplication<FretterContext> application)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                quantidade = await _application.ProcessaConciliacaoControle();
