...
namespace Fretter.Service.Tasks
{
    ...
    class ProcessaEntregaDevolucaoCancelamentoTask : IJob, IJobTask
    {
        private readonly ILogHelper _logHelper;
        private readonly IEntregaDevolucaoApplication<FretterContext> _application;

        public ProcessaEntregaDevolucaoCancelamentoTask(ILogHelper logHelper, IEntregaDevolucaoApplication<FretterContext> application)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                int quantidade = await _application.ProcessaEntregaDevolucaoCancelamento();
