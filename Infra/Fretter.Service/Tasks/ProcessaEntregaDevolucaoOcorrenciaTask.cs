...
namespace Fretter.Service.Tasks
{
    ...
    class ProcessaEntregaDevolucaoOcorrenciaTask : IJob, IJobTask
    {
        private readonly ILogHelper _logHelper;
        private readonly IEntregaDevolucaoApplication<FretterContext> _application;

        public ProcessaEntregaDevolucaoOcorrenciaTask(ILogHelper logHelper, IEntregaDevolucaoApplication<FretterContext> application)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                int quantidade = await _application.ProcessaEntregaDevolucaoOcorrencia();
